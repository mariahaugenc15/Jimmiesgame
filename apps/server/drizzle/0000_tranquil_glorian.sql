...
CREATE TYPE "public"."position" AS ENUM('QB', 'RB', 'WR', 'TE', 'DEF', 'K');--> statement-breakpoint
CREATE TYPE "public"."roster_slot" AS ENUM('QB', 'RB', 'WR', 'TE', 'FLEX', 'DEF', 'K', 'BENCH');--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "nfl_players_external_idx" ON "nfl_players" USING btree ("external_id");--> statement-breakpoint
